        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Single Building Legal Entry</div>

                    <div class="panel-body">

                        {{ Form::model($legal, array('route' => ['single_legal.update', $legal->id],'class'=>'form-horizontal','enctype'=>'multipart/form-data')) }}
                        ...
                        <div class="form-group{{ $errors->has('building_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                    <h2>{{$legal->SingleBuilding->name}}</h2>
                        ...
                        <div class="form-group{{ $errors->has('plotted') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {{Form::select('plotted',['yes'=>'Yes','no'=>'No'],$legal->plotted,['class'=>'form-control','id'=>'plotted'])}}
                        ...
                        <div class="form-group{{ $errors->has('stamp_duty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {{Form::select('stamp_duty',['yes'=>'Yes','no'=>'No'],$legal->stamp_duty,['class'=>'form-control','id'=>'stamp_duty'])}}
                        ...
                        <div class="form-group{{ $errors->has('registered_deed') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {{Form::select('registered_deed',['yes'=>'Yes','no'=>'No'],$legal->registered_deed,['class'=>'form-control','id'=>'registered_deed'])}}
                        ...
                        <div class="form-group{{ $errors->has('registered_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {{Form::select('registered_title',['yes'=>'Yes','no'=>'No'],$legal->registered_title,['class'=>'form-control','id'=>'registered_title'])}}
                        ...
                        <div class="form-group{{ $errors->has('litigation_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {{Form::select('litigation_status',['yes'=>'Yes','no'=>'No'],$legal->litigation_status,['class'=>'form-control','id'=>'litigation_status'])}}
