                      ...
                      <table class="table-responsive table-condensed table-hover table-striped col-md-12">
                          ...
                          @foreach($physicals as $physical)
                              ...
                              <tr>
                                  ...
                                  <td><a href="{{route('bare_land_physical.edit',$physical->id)}}" ><span class="fa fa-edit fa-2x"></span></a></td>
                                  <td>
                                      <form method="POST" action="{{route('bare_land_physical.destroy',$physical->id)}}">
