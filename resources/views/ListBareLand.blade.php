        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Bare-Land List</div>
                      ...
                      <table class="table-responsive table-condensed table-hover table-striped col-md-12">
                          ...
                          @foreach($buildings as $building)
                              ...
                              <tr>
                                  ...
                                  <td><a href="{{route('bare_land.edit',$building->id)}}" ><span class="fa fa-edit fa-2x"></span></a></td>
                                  <td>
                                      <form method="POST" action="{{route('bare_land.destroy',$building->id)}}">
