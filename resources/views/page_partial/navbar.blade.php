                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item ">
                                <li><a href="{{route('single_legal.create')}}" >New</a></li>
                                <li><a href="{{route('single_legal.index')}}" >List</a></li>
                                </li>
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item ">
                                <li><a href="{{route('multi_building_legal.create')}}" >New</a></li>

                                <li><a href="{{route('multi_building_legal.index')}}" >List</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item ">
                                {{--<li><a href="{{route('single_video.multimedia')}}" >New</a></li>--}}
                                {{--<li><a href="{{route('single_video.multimedia')}}" >List</a></li>--}}
                                </li>
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item ">
                                {{--<li><a href="{{route('bare_land_multimedia.create')}}" >New</a></li>--}}
                                {{--<li><a href="{{route('bare_land_multimedia.index')}}" >List</a></li>--}}
                                </li>
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item ">
                                {{--<li><a href="{{route('multi_building_multimedia.create')}}" >New</a></li>--}}

                                {{--<li><a href="{{route('multi_building_multimedia.index')}}" >List</a></li>--}}
