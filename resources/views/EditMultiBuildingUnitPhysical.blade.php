        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Multi-Unit Building Physical Entry</div>

                    <div class="panel-body">

                        {{ Form::model($physical, array('route' => ['multi_unit_physical.update', $physical->id],'class'=>'form-horizontal')) }}
                        ...
                        <div class="form-group{{ $errors->has('building_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                              <h2>{{$physical->MultiBuilding->name}}</h2>
                            </div>
                        </div>
