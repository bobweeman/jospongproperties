        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Single Building Purchaser Addition</div>
                      ...
                      <table class="table-responsive table-condensed table-hover table-striped col-md-12">
                          ...
                          @foreach($buildings as $building)
                              ...
                              <tr>
                                  ...
                                  <td><a href="{{route('single_building_purchaser.edit',$building->id)}}" ><span class="fa fa-shopping-basket fa-2x"></span></a></td>
                                  {{--<td>--}}
